...
namespace AecialEngine.Tools
{
    public partial class DLLInjector : Form
    {
        ...
        private static bool CreateRemoteThread(Process pToBeInjected,string sDllPath,out string sError, out IntPtr hwnd)
        {
            ...
            IntPtr lpAddress = WINAPI.VirtualAllocEx(hndProc,(IntPtr)null,(IntPtr)sDllPath.Length,
                (uint)WINAPI.VAE_Enums.AllocationType.MEM_COMMIT |(uint)WINAPI.VAE_Enums.AllocationType.MEM_RESERVE,
            ...
            IntPtr ipThread = WINAPI.CreateRemoteThread( hndProc,(IntPtr)null,(IntPtr)0,lpLLAddress,
                lpAddress, 0,(IntPtr)null);
        ...
        {
            return (System.Text.Encoding.ASCII.GetBytes(sToConvert));
        } 
